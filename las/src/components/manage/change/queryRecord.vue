    ...
    <el-form  :model="form" label-width="80px" label-position="left">
        ...
        <el-row>
            ...
            <el-col :span="4" :offset="2">
                ...
                <el-button @click="exportExcel('#memberTable','修改记录')" icon="el-icon-download">导 出</el-button>
            </el-col>
        </el-row>
                ...
                element-loading-spinner="el-icon-loading">
                    ...
                    <el-table-column label="修改详情" align="center" width="120px">
                        <template slot-scope="scope">
                            <el-button type="success" size="mini"  @click="onShowDetails(scope.row)">查看</el-button>
                        </template>
                    </el-table-column>
                </el-table>
            </el-col>
