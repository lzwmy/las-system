    ...
    <el-form label-width="90px" label-position="left">
        <el-row>
            ...
            <el-col :span="4" :offset="1" :xs="6" :sm="6" :md="6" :lg="5" :xl="4">
                <el-form-item label="出库单号"><el-input v-model="form.whCode" @keyup.enter.native="onSearch"></el-input></el-form-item>
            </el-col>
        ...
        <el-row>
            ...
            <el-col :span="4" :offset="1">
                <el-form-item label="出库总计:"><span>30单/300,000.00元</span> </el-form-item>
            </el-col>
        </el-row>
         ...
         <el-row>
            <el-col :span="24">
                <el-table 
                    ...
                    <el-table-column prop="" label="订单单号" align="center">
                    </el-table-column>
                    <el-table-column prop="wareAmount" label="订单金额" align="center">
                    </el-table-column>
                    <el-table-column prop="" label="购物积分支付" align="center" width="140">
                    </el-table-column>
